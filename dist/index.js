...
const cli_1 = __nccwpck_require__(5308);
      ...
      case 'x64':
        ...
        try {
          if (localFileExisted) {
            ...
            nativeBinding = __nccwpck_require__(5673)
          }
        } catch (e) {
          loadError = e
        }
      ...
      case 'x64':
        ...
        try {
          if (localFileExisted) {
            ...
            nativeBinding = __nccwpck_require__(2774)
          }
        } catch (e) {
          loadError = e
        }
        ...
        if (isMusl()) {
          ...
          try {
            if (localFileExisted) {
              ...
              nativeBinding = __nccwpck_require__(3961)
            }
          } catch (e) {
            loadError = e
          }
...
const { run } = __nccwpck_require__(8296)
